...
class Books {	
	...
	public function listBook(){		
		...
		while ($book = $result->fetch_assoc()) { 				
			...
			$rows[] = '<button type="button" name="update" id="'.$book["bookid"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Edit">Edit</span></button>';
			$rows[] = '<button type="button" name="delete" id="'.$book["bookid"].'" class="btn btn-danger btn-xs delete" ><span class="glyphicon glyphicon-remove" title="Delete">Delete</span></button>';
			$records[] = $rows;
			$count++;
		}
